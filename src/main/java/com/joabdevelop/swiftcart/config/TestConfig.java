...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.parse("2022-06-20T20:53:07Z"), u1);
        Order o2 = new Order(null, Instant.parse("2022-06-25T03:12:41Z"), u2);
        Order o3 = new Order(null, Instant.parse("2022-07-05T20:19:12Z"), u1);
